...
## set plots with labels
with(dataSubset, {
        plot(Date, Global_active_power, xlab = "", ylab = "Global Active Power", cex.axis = 0.6, cex.lab = 0.5, type = "n")
        lines(dataSubset$Date, dataSubset$Global_active_power, type = "l")

        plot(Date, Voltage, xlab = "datetime", ylab ="Voltage", cex.axis = 0.6, cex.lab = 0.5, type = "n")
        lines(dataSubset$Date, dataSubset$Voltage, type = "l")

        plot(Date, Sub_metering_1, xlab = "", ylab = "Energy sub metering", cex.axis = 0.6, cex.lab = 0.65, type = "n")
        ...
        legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty = c(1, 1, 1), bty = "n", cex = 0.5)
        
        plot(Date, Global_reactive_power, cex.axis = 0.6, cex.lab = 0.5, type = "n")
        lines(dataSubset$Date, dataSubset$Global_reactive_power, type = "l")
})
